...
$curl = curl("http://localhost:8001/spmilaporanunitsadmin");
            ...
            <tbody>
             ...
             <tr>
              ...
              <td>
                ...
                @if (($d["opsi_id"] == 2))
                <a href="/listAllLaporan/<?php echo $d["laporan_unit_id"]; ?>/perbaikan" class="btn btn-default ">Perbaiki</a>
                @endif
              </td>
              @endif
              ...
              <td>
                <a href="/listAllLaporan/<?php echo $d["laporan_unit_id"]; ?>/detail" class="btn btn-info">View</a>
                <a href="/listAllAudit/<?php echo $d["laporan_unit_id"]; ?>/detail" class="btn btn-warning">Hasil Audit</a>
              </td>
              @endif
