        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Revisi Laporan</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="/listAllLaporan/{data}/revisii" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
               ...
               <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                    <label for="" class="col-sm-12 com-form-label">{{$data->spmilaporanunit->nama_laporan}}</label>
                    <input type="hidden" class="form-control" name="laporan_unit_id" id="" value="{{$data->laporan_unit_id}}" placeholder="">
                  </div>
                ...
                <div class="form-group row">
                  <label for="" class="col-sm-2 com-form-label">Komentar</label>
                  <div class="col-sm-6">
           ...
           <div class="form-group row">
            ...
            @if( $d->unggah_dokumen != null)
             ...
             <label for="" class="col-sm-3 com-form-label">Dokumen Pendukung</label>
               <div class="col-sm-9">
               <label  for="" class="col-sm-12 com-form-label">
                <a href="{{'/images/'.$data->unggah_dokumen}}" >: {{$d->unggah_dokumen}}</a></label>
              </div>
            </div>
            @endif
            ...
            <a href="/spmi_revisi_laporan_unit/spmi_revisi_laporan_units"<button>Kembali</button></a>
            @endif
          </div>
        </form>
